RSpec.describe "doubles" do
    ...
    it "sets up a double with methods" do
      fake_object = double :fake_object, speak: "Meow", count_ears: 2, count_legs: 4 #added methods on 1 line so that outcomes do not have to be renamed
      #fake_object_2 = double :fake_object_2, count_ears: 2
      #fake_object_3 = double :fake_object_3, count_legs: 4
      # Don't edit below
    ...
    it "creates a double for a specific case" do
      ...
      fake_diary = double :diary, count_entries: 2, add: nil
      allow(fake_diary).to receive(:add).with(double :diary_entry).and_return nil
